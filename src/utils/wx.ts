 ...
 * @LastEditros:
 * @LastEditTime: 2021-07-28 09:45:27
 */
/**
 * wechat jssdk 封装
...
export const wxJssdk = (config: any, content: any, bgm: any) => {
  wx.ready(function () {
    //需在用户可能点击分享按钮前就先调用
    ...
    //     let res = await wxShareCount()
    //     if(res.status === 200) {
    //       res.data.success === 1 && window.location.reload();
    //     }
    //   }
    // })
